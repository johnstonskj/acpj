...
/**
 * <p>
 * Internal - implmementation of the {@link com.googlecode.acpj.channels.ReadPort} interface.
 * </p>
 * 
 ...
 * 
 */
public class SimpleReadPort<T> extends SimplePort<T> implements ReadPort<T> {
	
	public SimpleReadPort(SimpleChannel<T> channel, int limit, Actor owner) {
		super(channel, limit, owner);
	}
	
	/*
	 * (non-Javadoc)
	 * @see com.googlecode.acpj.channels.ReadPort#read()
	 */
	public synchronized T read() throws IllegalStateException, ChannelException {
		if (isClosed()) {
